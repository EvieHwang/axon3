...
This makes all three Axon3 skills (`/ax-prep`, `/ax-build`, `/ax-init`) available in any Claude Code session run from the target project.
...
If `SPEC.md` does not already exist in the target project root, create it using the template at `.claude/skills/axon3/.claude/skills/ax-init/templates/spec-template.md`.
...
If `CLAUDE.md` does not already exist in the target project root, create it using the template at `.claude/skills/axon3/.claude/skills/ax-init/templates/claude-template.md`.
